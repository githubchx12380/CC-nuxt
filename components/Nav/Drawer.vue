<template>
    <div>
        ...
        <nav-bar-parent @click.native="hiddenDrawer" :fontw="true" path="/"><span class="icon-home"></span><span>首页</span></nav-bar-parent>
            ...
            <nav-bar-parent @click.native="hiddenDrawer" :fontw="true" path="/about"><span class="icon-home"></span><span>关于</span></nav-bar-parent>
        </el-drawer>
    </div>
</template>

<script>
import NavBarParent from '@/components/common/Nav_bar_parent'  
import NavBarItem from '@/components/common/Nav_bar_item'
